...
-- Database: PostgreSQL
-- Author: Final Year BE Project
-- Description: Complete schema with 8 tables, proper relationships
-- ===================================================================
...
VALUES (
    'admin', 
    '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5GyYzpLaEgXKK',  -- admin123
    'admin@smartecommerce.com',
...
-- ===================================================================
-- TRIGGERS (Optional but good for maintaining data integrity)
-- ===================================================================
